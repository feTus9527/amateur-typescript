// https://typehero.dev/challenge/unique-items
// FIXME
/// Input START
...
namespace UniqueItemsTest {
  declare const readonlyEqual: <A>() => <T>(
    value: T,
  ) => Equal<Readonly<A>, Readonly<T>>;
  ...
  expect(
    readonlyEqual<[undefined, null, 3, false]>()(
      uniqueItems([undefined, null, 3, false]),
    ),
  );
